			...
			Logo1: Backbone.View.extend({
				...
				scroll: function(scroll){
					if(scroll*this.mult <= this.parent.logo.children.ul3.ow){
						...
						// 1st word add 30px
						this.parent.logo.children.word1.translation.y = this.parent.logo.children.word1.oy + Math.min(scroll*this.mult - (this.parent.logo.children.ul3.ow - this.parent.logo.children.ul2.ow), 30);
					}
				},
				resize: function(){
					var rect = this.parent.logo.getBoundingClientRect();
